                                ...
                                for eight in range(0, 10):
                                    ...
                                    for nine in range(0, 10):
                                        ...
                                        for ten in range(0, 10):
                                            ...
                                            if (
                                                int(pandigital_number[1:4]) % 2 == 0
                                                and int(pandigital_number[2:5]) % 3 == 0
                                                and int(pandigital_number[3:6]) % 5 == 0
                                                and int(pandigital_number[4:7]) % 7 == 0
                                                and int(pandigital_number[5:8]) % 11
                                                == 0
                                                and int(pandigital_number[6:9]) % 13
                                                == 0
                                                and int(pandigital_number[7:10]) % 17
                                                == 0
                                            ):
                                                print(pandigital_number)
                                                sum_special_numbers += int(
                                                    pandigital_number
                                                )
...
def solution_2():
    ...
    for perm in permutations("0123456789"):
        ...
        for index, prime in zip(
            range(1, 10), [2, 3, 5, 7, 11, 13, 17]
        ):  # loops through two lists simultanously
